...
export const DEFAULT_PROFILE = Object.freeze({ name: '競標新手', money: 1000000, collection: [], hasChosenName: false, settings: { soundEnabled: true }, stats: { auctions: 0, wins: 0 }, auction: { selectedVenue: 'yard', selectedAssistant: 'surveyor', instruments: { sizeScanner: 0, qualityScanner: 0, valueProbe: 0, totalCellsMeter: 0, identityDecoder: 0, targetScanner: 0 } } });
